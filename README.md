...
* [gRPC](https://github.com/grpc/grpc/blob/master/doc/PROTOCOL-HTTP2.md) ⭐ 44,698 | 🐛 1,311 | 🌐 C++ | 📅 2026-05-01 - This document serves as a detailed description for an implementation of gRPC carried over HTTP2 framing.
...
* [API Security Checklist](https://github.com/shieldfy/API-Security-Checklist) ⭐ 23,226 | 🐛 2 | 📅 2026-02-10 - Checklist of the most important security countermeasures.
* [Apache Thrift](https://github.com/apache/thrift/tree/master/doc/specs) ⭐ 10,916 | 🐛 14 | 🌐 C++ | 📅 2026-05-02 - Interface Definition Language and binary communication protocol used for defining and creating services for programming languages.
...
* [Zig Proposals](https://github.com/ziglang/zig/issues?q=is:issue+is:open+label:proposal) ⭐ 42,889 | 🐛 3,134 | 🌐 Zig | 📅 2025-11-27 - Issues with Proposal label in Zig repository.
...
* [C# Design](https://github.com/dotnet/csharplang) ⭐ 12,588 | 🐛 277 | 🌐 C# | 📅 2026-05-01 - C# Language Design Proposals.
* [KEEP](https://github.com/Kotlin/KEEP) ⭐ 3,706 | 🐛 15 | 🌐 Markdown | 📅 2026-04-27 - Kotlin Evolution and Enhancement Process.
* [Go Proposals](https://github.com/golang/proposal) ⭐ 3,447 | 🐛 4 | 🌐 HTML | 📅 2026-04-23 - Design discussions for Go language evolution.
* [Dart Design](https://github.com/dart-lang/language) ⭐ 2,906 | 🐛 1,303 | 🌐 TeX | 📅 2026-04-24 - Design of the Dart language.
...
* [CEPs](https://github.com/coq/ceps) ⭐ 64 | 🐛 56 | 📅 2025-01-15 - Coq Enhancement Proposals.
...
* [React RFCs](https://github.com/reactjs/rfcs) ⭐ 5,793 | 🐛 47 | 📅 2024-06-11 - Change requests for React.
* [Vue RFCs](https://github.com/vuejs/rfcs) ⭐ 4,944 | 🐛 60 | 📅 2025-01-08 - Suggestions for major changes to Vue.js.
* [OTEPs](https://github.com/open-telemetry/opentelemetry-specification/tree/main/oteps/) ⭐ 4,230 | 🐛 643 | 🌐 Makefile | 📅 2026-04-30 - OpenTelemetry Enhancement Proposals.
* [Compose Specification](https://github.com/compose-spec/compose-spec) ⭐ 2,661 | 🐛 29 | 🌐 Dockerfile | 📅 2026-04-09 - The Compose Specification is developer focused for defining cloud and platform agnostic container-based applications.
...
* [Fluent Specs](https://github.com/projectfluent/fluent) ⭐ 1,640 | 🐛 75 | 🌐 JavaScript | 📅 2026-03-21 - This repository contains the specification, the reference implementation of the parser and the documentation for Fluent.
* [npm RFCs](https://github.com/npm/rfcs) ⭐ 766 | 🐛 178 | 🌐 JavaScript | 📅 2026-03-24 - Change proposals for npm.
* [Nix RFCs](https://github.com/NixOS/rfcs) ⭐ 639 | 🐛 27 | 🌐 Markdown | 📅 2025-05-26 - The Nix community RFCs.
* [DEPs](https://github.com/django/deps) ⭐ 523 | 🐛 13 | 📅 2026-04-20 - Django Enhancement Proposals.
...
* [HeadVer Spec](https://github.com/line/headver) ⭐ 296 | 🐛 1 | 📅 2024-03-08 - SemVer compatible version specification that has {head}.{yearweek}.{build} system.
...
* [ESLint RFCs](https://github.com/eslint/rfcs) ⭐ 150 | 🐛 10 | 📅 2026-04-20 - Change requests for ESLint.
* [JEPs](https://github.com/jenkinsci/jep) ⭐ 150 | 🐛 4 | 🌐 Shell | 📅 2026-05-02 - Jenkins Enhancement Proposals.
...
* [BIPs](https://github.com/bitcoin/bips) ⭐ 10,747 | 🐛 42 | 🌐 Wikitext | 📅 2026-05-01 - Bitcoin Improvement Proposals.
* [BOLTs](https://github.com/lightning/bolts) ⭐ 2,230 | 🐛 79 | 🌐 Markdown | 📅 2026-03-23 - Basis of Lightning Technology (Lightning Network Specifications).
* [LibP2P Specs](https://github.com/libp2p/specs) ⭐ 1,766 | 🐛 184 | 📅 2026-04-15 - Technical specifications for the libp2p networking stack.
* [SLIPs](https://github.com/satoshilabs/slips) ⭐ 1,673 | 🐛 21 | 🌐 Markdown | 📅 2026-04-13 - SatoshiLabs Improvement Proposals.
...
* [HCS](https://github.com/hiero-ledger/hiero-consensus-specifications) ⭐ 528 | 🐛 11 | 📅 2026-04-09 - Hiero Consensus Standards.
...
* [NEPs](https://github.com/near/NEPs) ⭐ 237 | 🐛 12 | 📅 2026-04-29 - NEAR Protocol Specifications and Standards.
...
* [OWASP MASVS](https://github.com/OWASP/owasp-masvs) ⭐ 2,367 | 🐛 2 | 🌐 Python | 📅 2025-12-22 - Mobile Application Security Verification Standard is the industry standard for mobile app security.
...
* [Awesome Guidelines](https://github.com/Kristories/awesome-guidelines) ⭐ 10,768 | 🐛 0 | 🌐 JavaScript | 📅 2026-04-20 - Coding style conventions and standards.
