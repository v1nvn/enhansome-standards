...
* [gRPC](https://github.com/grpc/grpc/blob/master/doc/PROTOCOL-HTTP2.md) ⭐ 44,572 | 🐛 1,208 | 🌐 C++ | 📅 2026-04-01 - This document serves as a detailed description for an implementation of gRPC carried over HTTP2 framing.
...
* [Apache Thrift](https://github.com/apache/thrift/tree/master/doc/specs) ⭐ 10,910 | 🐛 12 | 🌐 C++ | 📅 2026-03-31 - Interface Definition Language and binary communication protocol used for defining and creating services for programming languages.
* [CloudEvents Spec](https://github.com/cloudevents/spec) ⭐ 5,715 | 🐛 19 | 🌐 Python | 📅 2026-03-26 - A specification for describing event data in a common way.
...
* [Siren](https://github.com/kevinswiber/siren) ⭐ 1,341 | 🐛 38 | 📅 2020-10-19 - Structured Interface for Representing Entities, super-rad hypermedia, defines links and actions.
...
* [Zig Proposals](https://github.com/ziglang/zig/issues?q=is:issue+is:open+label:proposal) ⭐ 42,799 | 🐛 3,419 | 🌐 Zig | 📅 2025-11-27 - Issues with Proposal label in Zig repository.
* [ECMAScript Proposals](https://github.com/tc39/proposals) ⭐ 19,090 | 🐛 7 | 📅 2026-03-31 - Ecma TC39 (Technical Committee 39) is responsible for evolving the ECMAScript programming language and authoring the specification.
* [C# Design](https://github.com/dotnet/csharplang) ⭐ 12,553 | 🐛 279 | 🌐 C# | 📅 2026-03-31 - C# Language Design Proposals.
* [KEEP](https://github.com/Kotlin/KEEP) ⭐ 3,698 | 🐛 14 | 🌐 Markdown | 📅 2026-03-30 - Kotlin Evolution and Enhancement Process.
* [Go Proposals](https://github.com/golang/proposal) ⭐ 3,446 | 🐛 4 | 🌐 HTML | 📅 2026-03-18 - Design discussions for Go language evolution.
* [Dart Design](https://github.com/dart-lang/language) ⭐ 2,895 | 🐛 1,302 | 🌐 TeX | 📅 2026-04-01 - Design of the Dart language.
* [GHC Proposals](https://github.com/ghc-proposals/ghc-proposals) ⭐ 703 | 🐛 196 | 🌐 Python | 📅 2026-03-25 - Compiler and language changes for Haskell/GHC.
...
* [OTEPs](https://github.com/open-telemetry/opentelemetry-specification/tree/main/oteps/) ⭐ 4,200 | 🐛 654 | 🌐 Makefile | 📅 2026-03-30 - OpenTelemetry Enhancement Proposals.
...
* [Fluent Specs](https://github.com/projectfluent/fluent) ⭐ 1,633 | 🐛 75 | 🌐 JavaScript | 📅 2026-03-21 - This repository contains the specification, the reference implementation of the parser and the documentation for Fluent.
...
* [BIPs](https://github.com/bitcoin/bips) ⭐ 10,674 | 🐛 56 | 🌐 Wikitext | 📅 2026-03-24 - Bitcoin Improvement Proposals.
...
* [LibP2P Specs](https://github.com/libp2p/specs) ⭐ 1,759 | 🐛 175 | 📅 2026-03-31 - Technical specifications for the libp2p networking stack.
...
* [HCS](https://github.com/hiero-ledger/hiero-consensus-specifications) ⭐ 347 | 🐛 11 | 📅 2026-03-27 - Hiero Consensus Standards.
...
* [Awesome Guidelines](https://github.com/Kristories/awesome-guidelines) ⭐ 10,696 | 🐛 0 | 🌐 JavaScript | 📅 2026-03-30 - Coding style conventions and standards.
* [Awesome API Devtools](https://github.com/yosriady/awesome-api-devtools) ⭐ 4,008 | 🐛 21 | 📅 2025-12-20 - A collection of useful resources for building RESTful HTTP+JSON APIs.
