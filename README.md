...
* [gRPC](https://github.com/grpc/grpc/blob/master/doc/PROTOCOL-HTTP2.md) ⭐ 44,354 | 🐛 1,179 | 🌐 C++ | 📅 2026-02-14 - This document serves as a detailed description for an implementation of gRPC carried over HTTP2 framing.
* [Microsoft REST API Guidelines](https://github.com/Microsoft/api-guidelines) ⭐ 23,231 | 🐛 168 | 📅 2025-08-11 - Repository contains a collection of documents and related materials.
...
* [Apache Thrift](https://github.com/apache/thrift/tree/master/doc/specs) ⭐ 10,896 | 🐛 17 | 🌐 C++ | 📅 2026-02-11 - Interface Definition Language and binary communication protocol used for defining and creating services for programming languages.
* [CloudEvents Spec](https://github.com/cloudevents/spec) ⭐ 5,681 | 🐛 19 | 🌐 Python | 📅 2026-02-12 - A specification for describing event data in a common way.
...
* [JSEND](https://github.com/omniti-labs/jsend) ⭐ 1,705 | 🐛 9 | 📅 2022-01-21 - Specification for a simple, no-frills, JSON based format for application-level communication.
...
* [Zig Proposals](https://github.com/ziglang/zig/issues?q=is:issue+is:open+label:proposal) ⭐ 42,682 | 🐛 3,510 | 🌐 Zig | 📅 2025-11-27 - Issues with Proposal label in Zig repository.
* [ECMAScript Proposals](https://github.com/tc39/proposals) ⭐ 19,057 | 🐛 5 | 📅 2026-02-04 - Ecma TC39 (Technical Committee 39) is responsible for evolving the ECMAScript programming language and authoring the specification.
* [C# Design](https://github.com/dotnet/csharplang) ⭐ 12,501 | 🐛 274 | 🌐 C# | 📅 2026-02-14 - C# Language Design Proposals.
* [KEEP](https://github.com/Kotlin/KEEP) ⭐ 3,682 | 🐛 31 | 🌐 Markdown | 📅 2026-02-13 - Kotlin Evolution and Enhancement Process.
* [Go Proposals](https://github.com/golang/proposal) ⭐ 3,442 | 🐛 4 | 🌐 HTML | 📅 2025-12-17 - Design discussions for Go language evolution.
* [Dart Design](https://github.com/dart-lang/language) ⭐ 2,879 | 🐛 1,300 | 🌐 TeX | 📅 2026-02-12 - Design of the Dart language.
* [GHC Proposals](https://github.com/ghc-proposals/ghc-proposals) ⭐ 701 | 🐛 191 | 🌐 Python | 📅 2026-01-05 - Compiler and language changes for Haskell/GHC.
* [F# Design](https://github.com/fsharp/fslang-design) ⭐ 546 | 🐛 27 | 🌐 F# | 📅 2026-02-13 - F# Language Design RFCs.
* [OCaml RFCs](https://github.com/ocaml/RFCs) ⭐ 172 | 🐛 31 | 📅 2025-12-12 - Design discussions about the OCaml language.
...
* [OTEPs](https://github.com/open-telemetry/opentelemetry-specification/tree/main/oteps/) ⭐ 4,178 | 🐛 622 | 🌐 Makefile | 📅 2026-02-13 - OpenTelemetry Enhancement Proposals.
* [Compose Specification](https://github.com/compose-spec/compose-spec) ⭐ 2,617 | 🐛 28 | 🌐 Dockerfile | 📅 2026-02-09 - The Compose Specification is developer focused for defining cloud and platform agnostic container-based applications.
* [React Native RFCs](https://github.com/react-native-community/discussions-and-proposals) ⭐ 1,808 | 🐛 247 | 📅 2025-09-26 - React Native enhancement discussions.
* [Fluent Specs](https://github.com/projectfluent/fluent) ⭐ 1,620 | 🐛 73 | 🌐 JavaScript | 📅 2026-01-02 - This repository contains the specification, the reference implementation of the parser and the documentation for Fluent.
* [npm RFCs](https://github.com/npm/rfcs) ⭐ 763 | 🐛 175 | 🌐 JavaScript | 📅 2026-01-16 - Change proposals for npm.
* [Nix RFCs](https://github.com/NixOS/rfcs) ⭐ 622 | 🐛 26 | 🌐 Markdown | 📅 2025-05-26 - The Nix community RFCs.
* [DEPs](https://github.com/django/deps) ⭐ 518 | 🐛 10 | 📅 2025-11-03 - Django Enhancement Proposals.
* [HIPs](https://github.com/helm/community) ⭐ 479 | 🐛 102 | 📅 2026-02-05 - Helm Improvement Proposals.
...
* [CEPs](https://github.com/conda/ceps) ⭐ 27 | 🐛 87 | 📅 2026-02-02 - Conda Enhancement Proposals.
...
* [BIPs](https://github.com/bitcoin/bips) ⭐ 10,574 | 🐛 73 | 🌐 Wikitext | 📅 2026-02-13 - Bitcoin Improvement Proposals.
* [BOLTs](https://github.com/lightning/bolts) ⭐ 2,223 | 🐛 76 | 🌐 Markdown | 📅 2026-02-13 - Basis of Lightning Technology (Lightning Network Specifications).
* [LibP2P Specs](https://github.com/libp2p/specs) ⭐ 1,752 | 🐛 173 | 📅 2026-01-29 - Technical specifications for the libp2p networking stack.
...
* [BEPs](https://github.com/bittorrent/bittorrent.org) ⭐ 425 | 🐛 87 | 🌐 HTML | 📅 2024-05-29 - BitTorrent Enhancement Proposals.
...
* [NEPs](https://github.com/near/NEPs) ⭐ 237 | 🐛 14 | 📅 2026-02-04 - NEAR Protocol Specifications and Standards.
* [SNIPs](https://github.com/starknet-io/SNIPs) ⭐ 194 | 🐛 0 | 📅 2026-02-10 - Starknet Improvement Proposals.
* [PIPs](https://github.com/maticnetwork/Polygon-Improvement-Proposals) ⭐ 117 | 🐛 5 | 📅 2026-02-13 - Polygon Improvement Proposals.
...
* [HCS](https://github.com/hiero-ledger/hiero-consensus-specifications) ⭐ 74 | 🐛 6 | 📅 2026-02-10 - Hiero Consensus Standards.
...
* [OWASP MASVS](https://github.com/OWASP/owasp-masvs) ⭐ 2,330 | 🐛 2 | 🌐 Python | 📅 2025-12-22 - Mobile Application Security Verification Standard is the industry standard for mobile app security.
...
* [Awesome Guidelines](https://github.com/Kristories/awesome-guidelines) ⭐ 10,599 | 🐛 0 | 🌐 JavaScript | 📅 2026-02-02 - Coding style conventions and standards.
* [Awesome API Devtools](https://github.com/yosriady/awesome-api-devtools) ⭐ 4,002 | 🐛 8 | 📅 2025-12-20 - A collection of useful resources for building RESTful HTTP+JSON APIs.
