...
* [gRPC](https://github.com/grpc/grpc/blob/master/doc/PROTOCOL-HTTP2.md) ⭐ 44,531 | 🐛 1,209 | 🌐 C++ | 📅 2026-03-20 - This document serves as a detailed description for an implementation of gRPC carried over HTTP2 framing.
* [Microsoft REST API Guidelines](https://github.com/Microsoft/api-guidelines) ⭐ 23,250 | 🐛 168 | 📅 2025-08-11 - Repository contains a collection of documents and related materials.
* [API Security Checklist](https://github.com/shieldfy/API-Security-Checklist) ⭐ 23,206 | 🐛 2 | 📅 2026-02-10 - Checklist of the most important security countermeasures.
* [Apache Thrift](https://github.com/apache/thrift/tree/master/doc/specs) ⭐ 10,908 | 🐛 17 | 🌐 C++ | 📅 2026-03-21 - Interface Definition Language and binary communication protocol used for defining and creating services for programming languages.
...
* [Zig Proposals](https://github.com/ziglang/zig/issues?q=is:issue+is:open+label:proposal) ⭐ 42,846 | 🐛 3,429 | 🌐 Zig | 📅 2025-11-27 - Issues with Proposal label in Zig repository.
...
* [Dart Design](https://github.com/dart-lang/language) ⭐ 2,893 | 🐛 1,300 | 🌐 TeX | 📅 2026-03-18 - Design of the Dart language.
...
* [Fluent Specs](https://github.com/projectfluent/fluent) ⭐ 1,630 | 🐛 75 | 🌐 JavaScript | 📅 2026-03-21 - This repository contains the specification, the reference implementation of the parser and the documentation for Fluent.
* [npm RFCs](https://github.com/npm/rfcs) ⭐ 766 | 🐛 177 | 🌐 JavaScript | 📅 2026-03-20 - Change proposals for npm.
* [Nix RFCs](https://github.com/NixOS/rfcs) ⭐ 627 | 🐛 26 | 🌐 Markdown | 📅 2025-05-26 - The Nix community RFCs.
...
* [BIPs](https://github.com/bitcoin/bips) ⭐ 10,665 | 🐛 55 | 🌐 Wikitext | 📅 2026-03-17 - Bitcoin Improvement Proposals.
...
* [OWASP MASVS](https://github.com/OWASP/owasp-masvs) ⭐ 2,348 | 🐛 2 | 🌐 Python | 📅 2025-12-22 - Mobile Application Security Verification Standard is the industry standard for mobile app security.
...
* [Awesome Guidelines](https://github.com/Kristories/awesome-guidelines) ⭐ 10,667 | 🐛 1 | 🌐 JavaScript | 📅 2026-03-05 - Coding style conventions and standards.
* [Awesome API Devtools](https://github.com/yosriady/awesome-api-devtools) ⭐ 4,008 | 🐛 17 | 📅 2025-12-20 - A collection of useful resources for building RESTful HTTP+JSON APIs.
